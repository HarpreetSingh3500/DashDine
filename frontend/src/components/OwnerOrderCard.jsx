...
function OwnerOrderCard({ data }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 space-y-4">
      ...
      <div>
        ...
        {data.paymentMethod == "online" ? (
          <p className="text-sm font-semibold text-gray-600 mt-1">
            Payment: {data.payment ? "Successful" : "Failed"}
          </p>
        ) : (
          <p className="text-sm font-semibold text-gray-600 mt-1">
      ...
      <div className="flex items-start flex-col gap-1 text-gray-600 text-sm">
      ...
      {/* ordered food items mapping*/}
      <div className="flex space-x-4 overflow-x-auto pb-2">
        {/* shop order items mapping */}
      ...
      <div className="flex justify-between items-center mt-auto pt-3 border-t border-gray-100">
        ...
        {/* only displays status selector for undelivered orders */}

        {data.shopOrders.status === "delivered" ? (
          <span className="font-semibold text-green-600 px-3 py-1">
            Delivered
          </span>
        ) : (
          <select
      ...
      {/* mapping available delivery boys and display them to owner */}
